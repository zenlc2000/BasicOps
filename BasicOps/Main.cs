...
namespace BasicOps
{
	class MainClass
	{
		...
		public HttpWebRequest makeRequest()
		{
			...
			string urlString = "https://api.gnip.com:443/accounts/mike/publishers/twitter/streams/track/track/rules.json";			
			                    
			HttpWebRequest request = (HttpWebRequest)WebRequest.Create(urlString);
			
			string username = "mbusch@gnipcentral.com";
			string password = "nexus7";
